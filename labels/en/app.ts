...
export const appLabels: AppLabels["app"] = {
  ...
  admin: {
    ...
    emailVerificationStateLabel: "Email verification",
    emailVerifiedStateLabel: "Verified",
    emailUnverifiedStateLabel: "Unverified",
    createdLabel: "Created",
    updatedLabel: "Updated",
    neverLabel: "Never",
    emptyValue: "Not set",
    userEditHeading: "Editable account fields",
    userEditCta: "Save changes",
    userEditPendingCta: "Saving...",
    systemRoleAdminLabel: "Admin",
    systemRoleUserLabel: "User",
    passwordResetHeading: "Password reset",
    passwordResetCta: "Send reset email",
    passwordResetPendingCta: "Sending...",
